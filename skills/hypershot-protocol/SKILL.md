...
description: Design prompt templates and model-facing artifacts with abstract structural examples that prime form without importing task-specific content.
---
