...
The validated platform behavior gives the model-visible skill catalog a budget
of roughly two percent of context or 8,000 characters, with description
shortening before omission. Treat frontmatter descriptions as indexed routing
labels.
