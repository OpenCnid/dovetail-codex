...
description: Structure or improve prompts, templates, agent instructions, and output schemas using clear hierarchy, semantic boundaries, placeholders, and attention control.
license: CC-BY-4.0
---
