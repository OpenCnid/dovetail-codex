...
This port is pinned to the platform snapshot in `2026-09-02-codex/`:
Codex Desktop `26.820.9563.0` and CLI `0.150.0-alpha.8` on Windows. Observed
behavior takes priority over documentary behavior; version-sensitive claims
should be re-probed before they become standing instructions.
